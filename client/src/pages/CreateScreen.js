...
export default function CreateScreen() {
    ...
    function mintIdea(){
        console.log("Write MINT code", ideaForm.title, ideaForm.problem);
    }

    return (
        <div className="main-content">
            <p>Mint your ideas into Non-Fingible Tokens(NFT) and tokenize your IP Rights into Digital Asset. </p>
